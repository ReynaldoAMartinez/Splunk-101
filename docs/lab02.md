# Steps to set up Universal Forwarder
...
If Splunk cannot find the file in local, it searches it in default

I should edit  inputs.conf

<img width="265" height="173" alt="image" src="https://github.com/user-attachments/assets/e6eeb767-2ffa-41b8-92b1-feb0436b3532" />

After that, I restart the service
...
And restart the SplunkForwarded service to update the ingestion to Splunk
